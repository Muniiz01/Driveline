...
$output .= "<div class= 'container mt-5 mb-5 bg-light d-flex gap-3 align-items-center text-secondary'>
...
$output .= '<img src="'.($row["caminho_imagem"]).'" class="rounded float-start" width="500px" height="400px">
</div>

<div class="d-flex flex-column">
            <h1 class="display-6 mb-3 mt-3">'.($row['marca']).' '.($row['modelo']).'</h1>
            <div class="d-flex align-items-end">
                <h2>'.($row['preco_veiculo']).'</h2><p class="ms-2">Diaria</p>
            </div>
            ...
            <div class="d-flex">
                ...
                <div class="d-flex justify-content-end align-items-end" style="width: 55%;">
