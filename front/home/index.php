    ...
    <div class="slider_pai">
        <div class="elementos_slide">
            ...
            <div class="slide primeiro">
                <img src="../imagens/slider/EXEMPLO!.png" alt="imagem1">
            </div>
            <div class="slide segundo">
                <img src="../imagens/slider/promoção.png" alt="imagem2">
            </div>
            <div class="slide terceiro">
                <!-- <img src="imagens/slider/valve.png" alt="imagem3"> -->
            </div>
            <div class="slide quarto">
                <!-- <img src="imagens/slider/acdc.png" alt="imagem4"> -->
            </div>
            <!-- fim das imagens -->
